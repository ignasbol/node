...
# ---------------------------Example-input-line--------------------------------
# 286952 : /java/opt/IBM/WAS70GA_32bit/java/bin/java parm1 parm2 parm3
# -----------------------------------------------------------------------------
state == "PROCMAP_START" {
...
END {
  ...
  if ( procmap_grand_total ) {
# djones6 20100903 - switching back to include mmap'd client segments as the shared class cache in Java626
