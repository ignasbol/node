...
var instances = process.argv[2] || 1;
var port = process.argv[3] || settings.port;
var mongo_host = process.argv[4] || 'localhost';
var host = 'localhost';
...
/* The MongoDB host is normally picked up from the settings.json file,
   so we have to provide a changed version of that to the application. */
var updatedSettings = settings;
updatedSettings.mongoHost = mongo_host;

var routes = new require('./routes/index.js')(dbtype, authService, updatedSettings);
var loader = new require('./loader/loader.js')(routes, updatedSettings);
...
logger.info("Server is ready to run a smarter planet");
